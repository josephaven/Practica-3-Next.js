...
type Props = {
    onEdit: (s: Student) => void; // ← recibimos callback para abrir modal
};
                    ...
                    <tr key={s.id} className="border-t">
                        ...
                        <td className="p-3">
                            <div className="flex justify-end gap-1 sm:gap-2">
                                ...
                                <button
                                    onClick={() => remove(s.id)}
                                    className="inline-flex items-center justify-center rounded-md p-2 text-red-600 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 cursor-pointer disabled:opacity-50"
